        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    <div class="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v3m6 0V3m-12 3V3m12 3H6v15a2 2 0 002 2h8a2 2 0 002-2V6z"></path>
                        </svg>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <h4 class="text-xl font-semibold mb-2">3. Reporta Problemas</h4>
                    <p class="text-gray-600">Si lo deseas, reporta de forma anónima problemas que requieran atención inmediata.</p>
                </div>
            </div>
        </div>
    </section>
